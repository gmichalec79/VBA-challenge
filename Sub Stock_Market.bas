...
For Each ws In Worksheets
        ...
        'MsgBox ("Last row in column A is " & LastRowA)
            ...
            'Loop through all rows of worksheet
            For i = 2 To LastRowA
                ...
                ws.Cells(TickCount, 10).Value = ws.Cells(i, 6).Value - ws.Cells(j, 3).Value
                    ...
                    'Set cell color to red for negative change
                    ws.Cells(TickCount, 10).Interior.ColorIndex = 3
                
                    Else
                
                    'Set cell color to green for positive change
        ...
        GreatDecr = ws.Cells(2, 11).Value
            ...
            For i = 2 To LastRowI
                ...
                'For greatest total volume,check if next value is larger,if yes take new value and populate ws.Cells
                ...
                'For greatest increase,check if next value is larger if yes take new value and populate ws.Cells
                ...
                'For greatest decrease check if next value is smaller if yes take new value and populate ws.Cells
